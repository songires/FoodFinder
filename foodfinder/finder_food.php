...
<div class="page-header">
  <h2>Find by Food</h2>
  <h2>Enter your favourite dish and start searching for the restaurants.</h2>
</div>
...
<div class="container">
    <div class="row">
        ...
        <form id="form1" name="search" action="finder_food.php" method="get" target="_self">
          <div class="col-lg-12">
                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>
                <div class="form-group">
                    <label for="InputName">Food Item</label>
                    <div class="input-group">
                        <input class="form-control" name="item" type="item"  placeholder="Food Item" autofocus required>
...
<!--<footer id="footer">
    <p>External Links<p>
    <p>Original recipe and photos from: <a href="http://www.vegrecipesofindia.com/paneer-tikka-masala-recipe/">Veg Recipes of India</a></p        >
    <p>You can view the HTML Page with photos at: <a href="http://ella.ils.indiana.edu/~kmsheth/CSS_Competency/Paneer_Tikka_Masala.html"> Ella Server</a>       </p> 
</footer>
</body>
</html>
-->
...
$query="SELECT * FROM $tbl_name WHERE item='".$_GET['item']."'";
