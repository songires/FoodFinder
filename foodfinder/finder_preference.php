...
<div class="page-header">
  <h2>Find by Preferences</h2>
  <h2>Enter your preferences and start searching for the restaurants.</h2>
</div>
...
<div class="container">
    <div class="row">
        ...
        <form id="form1" name="search" action="finder_preference.php" method="_self">
          <div class="col-lg-12">
                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>
                <div class="form-group">
                    <label for="InputName">Location</label>
                    <div class="input-group">
                        <input class="form-control" name="location" type="location"  placeholder="Location (Bloomington)" autofocus required/>
...
$query="SELECT hotel_name, page_name FROM $tbl_name WHERE location='".$_GET['location']."' AND delivery='".$_GET['delivery']."'";
...
while ($i < $num) 
{
	$field1=mysql_result($result,$i,"hotel_name");
	$field2=mysql_result($result,$i,"page_name");
	//echo <style="background-color:blue">;
	echo "<center> 
			<b>Hotel:  </b><u>$field1</u><br> 
			<b>Visit:  </b><a href=".$field2."><u>$field2</u></a> <br>
			</center>";
	echo "<br>";
	$i++;
}
